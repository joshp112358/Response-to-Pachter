...
n_a <- length(na.omit(filter(df, (lettergroup == "A Only"|lettergroup == "A and B")&(role=="professor"))$amscit))
n_b <- length(na.omit(filter(df, (lettergroup == "B and C"|lettergroup == "B Only"|lettergroup == "A and B")&(role=="professor"))$amscit))
n_c <- length(na.omit(filter(df, (lettergroup == "C Only"|lettergroup == "B and C")&(role=="professor"))$amscit))
...
mean(filter(df, (lettergroup == "B and C"|lettergroup == "B Only"|lettergroup == "A and B")&role=="professor")$amscitperyear, na.rm = TRUE)
